// /api/generate.ts
// This is a Vercel Edge Function that acts as a secure proxy to the OpenRouter API.

// Vercel's config for Edge Functions, ensuring fast performance.
export const config = {
  runtime: 'edge',
};
...
export default async function handler(request: Request) {
  ...
  try {
    ...
    // Securely access the OpenRouter API key from Vercel's environment variables.
